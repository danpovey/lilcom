...
inputArray = numpy.array([random.randrange(-(2**15), 2**15 - 1)
                         for i in range(n_samples)]).astype(numpy.int16)
...
print("Shapes {} {} {} ".format(inputArray.shape, outputArray.shape,
                                reconstruction.shape))
a = lilcom.compress_int16(inputArray, outputArray, lpc_order=5,
